...
// Create a mock function for when Tinybird is not available
const mockIngestEndpoint = () => async (data: any) => {
  console.warn("Tinybird not configured - TINYBIRD_TOKEN missing. Analytics data not recorded.");
